...
urlpatterns = [
    ...
    path("api/run/start/", views.api_run_start, name="api_run_start"),
    path("api/run/point/", views.api_run_point, name="api_run_point"),
    path("api/run/finish/", views.api_run_finish, name="api_run_finish"),
